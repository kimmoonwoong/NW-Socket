...
namespace DummyClient
{
    ...
    class ServerSession : Session
    {
        public override void OnConnected(EndPoint endPoint)
        {
            ...
            var skile = new PlayerInfoReq.Skile() { id = 101, level = 1, duration = 3.2f };
            skile.attributes.Add(new PlayerInfoReq.Skile.Attribute() { att = 77 });
            packet.skiles.Add(skile);
            packet.skiles.Add(new PlayerInfoReq.Skile() { id = 102, level = 2, duration = 2.5f });
            packet.skiles.Add(new PlayerInfoReq.Skile() { id = 103, level = 3, duration = 3.1f });
            packet.skiles.Add(new PlayerInfoReq.Skile() { id = 104, level = 4, duration = 1.5f });
